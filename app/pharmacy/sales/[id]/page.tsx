        ...
        <div className="p-6 max-w-2xl mx-auto space-y-6 text-foreground">
            <div className="flex items-center justify-between print:hidden">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button variant="outline" onClick={() => window.print()} className="gap-2 border-border shadow-sm">
                        <Printer className="size-4" /> Imprimer
                    </Button>
                    <Button onClick={() => router.push("/pharmacy/sales/new")} className="gap-2 bg-primary text-primary-foreground shadow-lg shadow-primary/20">
                        <Plus className="size-4" /> Nouvelle Vente
                    </Button>
                </div>
            </div>

            <div className={cn(isThermal ? "hidden print:block" : "block print:block")}>
